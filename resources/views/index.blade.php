  ...
  <div class="container-fluid text-center">
   <div class="row">
     <div class="col-sm-3" id="footer1">
       <img class="img-fluid" src="cluby/facebook.svg" id="facebook">
       <img class="img-fluid" src="cluby/blogger.svg" id="blogger">
     </div>
     <div class="col-sm-9">
       <div id="footer2">
         <p id="textofooter">Próximamente descarga las aplicaciones</p>
         <img class="img-fluid" src="cluby/google.svg" id="playstore">
         <img class="img-fluid" src="cluby/app store.svg" id="appstore">
       </div>
     </div>
   </div>
 </div>
